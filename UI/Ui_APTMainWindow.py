...
class Ui_MainWindow(object):
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.pushButton_2.setToolTip(_translate("MainWindow", "Plot histogram between given points"))
        ...
        self.pushButton.setToolTip(_translate("MainWindow", "View first 5 rows of input matlab file"))
        self.pushButton.setText(_translate("MainWindow", "<- View Input DataFrame"))
        self.pushButton_4.setToolTip(_translate("MainWindow", "Start binning after completing table"))
        self.pushButton_4.setText(_translate("MainWindow", "Start Binning"))
        self.pushButton_7.setToolTip(_translate("MainWindow", "Display the detected peaks as dataframe"))
        self.pushButton_7.setText(_translate("MainWindow", "<- Show Peak Dataframe"))
        self.pushButton_8.setToolTip(_translate("MainWindow", "Show the contents of final dataframe before save"))
        self.pushButton_8.setText(_translate("MainWindow", "<- Show Final DataFrame"))
        self.pushButton_5.setToolTip(_translate("MainWindow", "Export final mapped dataframe"))
        self.pushButton_5.setText(_translate("MainWindow", "Export as HDF file"))
        self.pushButton_3.setToolTip(_translate("MainWindow", "Enter ions and their bin parameters in a table"))
