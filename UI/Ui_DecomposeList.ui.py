...
class Ui_Dialog(object):
    ...
    def retranslateUi(self, Dialog):
        ...
        self.pushButton.setToolTip(_translate("Dialog", "Add to list->"))
        self.pushButton.setText(_translate("Dialog", "+"))
        self.pushButton_2.setToolTip(_translate("Dialog", "Subtract from List <-"))
        self.pushButton_2.setText(_translate("Dialog", "-"))
        self.listWidget.setToolTip(_translate("Dialog", "Show the list of ions already present in the dataframe"))
        self.listWidget_2.setToolTip(_translate("Dialog", "Add the ins here that needs to be decomposed into component elements"))
